//
//  HearingLossAssessmentWorkerTests.swift
//  CGAssessmentTests
//
...
final class HearingLossAssessmentWorkerTests: XCTestCase {
    ...
    func testSaveAssessmentProgress() {
        ...
        do {
            try worker.updateHearingLossAssessmentProgress(with: .init(isDone: false))
