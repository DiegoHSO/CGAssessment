...
final class ZaritScaleWorkerTests: XCTestCase {
    ...
    func testGetAssessmentProgress() {
        ...
        do {
            let test = try worker.getZaritScaleProgress()
            ...
            XCTAssertEqual(rawQuestions, [.zaritScaleQuestionOne: .firstOption, .zaritScaleQuestionTwo: .firstOption, .zaritScaleQuestionThree: .firstOption,
    ...
    func testSaveAssessmentProgress() {
        ...
        do {
            try worker.updateZaritScaleProgress(with: .init(questions: [.zaritScaleQuestionOne: .thirdOption, .zaritScaleQuestionTwo: .secondOption, .zaritScaleQuestionThree: .secondOption,
                                                                        .zaritScaleQuestionFour: .firstOption, .zaritScaleQuestionFive: .thirdOption, .zaritScaleQuestionSix: .secondOption,
                                                                        .zaritScaleQuestionSeven: .firstOption
            ], isDone: false))
            currentExpectation?.fulfill()
        } catch {
            XCTFail("Test failed with error \(error.localizedDescription)")
