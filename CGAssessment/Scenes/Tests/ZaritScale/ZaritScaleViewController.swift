...
class ZaritScaleViewController: UIViewController, ZaritScaleDisplayLogic {
    ...
    private func setupViews() {
        ...
        tableView?.accessibilityIdentifier = "ZaritScaleViewController-tableView"
    }
}
...
extension ZaritScaleViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .question:
            ...
            cell.accessibilityIdentifier = "ZaritScaleViewController-SelectableTableViewCell-\(indexPath.section)-\(indexPath.row)"
        ...
        case .done:
            ...
            cell.accessibilityIdentifier = "ZaritScaleViewController-ActionButtonTableViewCell"
