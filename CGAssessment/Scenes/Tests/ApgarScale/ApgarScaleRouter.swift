...
protocol ApgarScaleRoutingLogic {
    func routeToTestResults(test: SingleDomainModels.Test, results: ApgarScaleModels.TestResults, cgaId: UUID?)
}

class ApgarScaleRouter: ApgarScaleRoutingLogic {
